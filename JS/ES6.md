...
**词法环境中的变量会先声明为uninitialized**，所以定义前不能使用。

>作者：王锤锤
链接：https://juejin.cn/post/6968848594459688967
https://vue3js.cn/interview/JavaScript/context_stack.html#%E4%BA%8C%E3%80%81%E7%94%9F%E5%91%BD%E5%91%A8%E6%9C%9F
...
#### object.assign和扩展运算符（...）是深拷贝还是浅拷贝，两者区别
...
两者都是浅拷贝。都可以拷贝symbol()
- Object.assign()方法接收的第一个参数作为目标对象，后面的所有参数作为源对象。然后**把所有的源对象合并到目标对象中**。它会**修改了一个对象**，因此会触发 ES6 setter。String类型和 Symbol 类型的属性都会被拷贝。
  >当对象中只有一级属性，没有二级属性的时候，此方法为深拷贝，但是对象中有对象的时候，此方法，在二级属性以后就是浅拷贝。（也就是说本质上还是浅拷贝）
